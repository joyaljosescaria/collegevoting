...
const Login2 = (props) => {
  ...
  const handleSubmit = (evt) => {
    evt.preventDefault();
    props.studentLogin(email, unique_id , password);
  }
            ...
            <Form role="form" onSubmit={handleSubmit}>
              ...
              <FormGroup>
                <InputGroup className="input-group-alternative">
                  ...
                  />
                  <button type="button" style={{ backgroundColor: "white", border: "0" , borderRadius:"6px"}} onClick={e => setShow(!show)} className="buton"><i className="fas fa-eye"></i></button>
                </InputGroup>
              </FormGroup>
...
export default connect(mapStateToProps, { studentLogin })(Login2)
